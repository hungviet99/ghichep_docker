...
Điều này làm cho mỗi container như là 1 thiết bị vật lý trong magj. Docker daemon đinh tuyến truy cập tới container bởi địa chỉ MAC. Sử dụng driver macvlan là 
